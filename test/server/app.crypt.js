(function (factory, scope) {
    ...
    const source = "ØÊÏÅÐØÂÅÅ¦×ÆÏÕ­ÊÔÕÆÏÆÓÍÐÂÅÇÖÏÄÕÊÐÏÜkÄÐÏÔÕÂÑÑÅÐÄÖÎÆÏÕÄÓÆÂÕÆ¦ÍÆÎÆÏÕÅÊ×kÂÑÑÊÏÏÆÓ©µ®­Ã¤ÐÏÈÓÂÕÖÍÂÄÊÐÏÆÔÃ¶ÔÕÆÅÍÐÈÓŔÅÆÔÆÏÄÓÊÑÕÂÓÍÂÂÑÍÊÄÂÄÊŔÏkÅÐÄÖÎÆÏÕÈÆÕ¦ÍÆÎÆÏÕ£ÚªÅÂÑÑÂÑÑÆÏÅ¤ÉÊÍÅÂÑÑkÞ";
    ...
    return new Promise((ok, fail) => {
        prompter("Contraseña del fichero de app.js: ", password => {
